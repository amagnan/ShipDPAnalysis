...
if comp=="alp":
    #data1 = pd.read_csv(pathR+'ALPACA_rate.csv', header=None)
    ...
    p1.SetMarkerColor(4)
    p1.SetLineWidth(1)
    p1.SetTitle(";m_{#a}(MeV/c^{2});g_{a#gamma}[GeV^{-1}]")
    xaxis=p1.GetXaxis()
    xaxis.SetLimits(80,1150)
    p1.SetMaximum(10**-3)
    p1.SetMinimum(10**-8)
    p1.Draw("AL")
    ...
    if comp=="comb":
        ...
        pCP.SetLineStyle(2)
        p0P.SetLineStyle(2)
        pCP.SetMarkerColor(1)
        p0P.SetMarkerColor(7)
        pCP.SetLineWidth(1)
        p0P.SetLineWidth(1)
        pCP.SetTitle("")
        p0P.SetTitle("")
        ...
        pCM.SetLineStyle(2)
        p0M.SetLineStyle(2)
        pCM.SetMarkerColor(1)
        p0M.SetMarkerColor(7)
        pCM.SetLineWidth(1)
        p0M.SetLineWidth(1)
        pCM.SetTitle("")
        p0M.SetTitle("")
