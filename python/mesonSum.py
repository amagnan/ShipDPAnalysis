...
def find(mother,l0,l_i):
    for i in l_i:
        ...
        elif  abs(math.log10(float(l0[0]))-math.log10(float(i[0])))<0.00001 and abs(math.log10(float(l0[1]))-math.log10(float(i[1])))<0.01: float(l0[0]), float(i[0]), float(l0[1]), float(i[1])
    return 0.
