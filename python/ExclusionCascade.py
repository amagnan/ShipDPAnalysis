...
if comp=="alp":
    ...
    if comp=="prod":
        ...
        data2n = pd.read_csv(pathR+'meson_Rate1_Ordered.csv', header=None)
        data2 = pd.read_csv('../data/200820/meson_Rate1_Ordered.csv', header=None)
        ...
        for i in data2n[0]: d20n.append(float(i))
        for i in data2n[1]: d21n.append(float(i))
        ...
        p2n=ROOT.TGraph(len(data2n[1]),d20n, d21n)
        ...
        p2.SetTitle("Meson")
        p2n.SetTitle("Meson with Cascade")
        p1.SetTitle("QCD")
        mulgr.Add(p2n)
        mulgr.Add(p2)
        mulgr.Add(p3)
        ...
        data2Pn = pd.read_csv(pathR+'meson_ErrorRateP_Ordered.csv', header=None)
        data2P = pd.read_csv('../data/200820/meson_ErrorRateP_Ordered.csv', header=None)
        ...
        for i in data2Pn[0]: d20Pn.append(float(i))
        for i in data2Pn[1]: d21Pn.append(float(i))
        ...
        p2Pn=ROOT.TGraph(len(data2Pn[1]),d20Pn, d21Pn)
        ...
        data2Mn = pd.read_csv(pathR+'meson_ErrorRateM_Ordered.csv', header=None)
        data2M = pd.read_csv('../data/200820/meson_ErrorRateM_Ordered.csv', header=None)
        ...
        for i in data2Mn[0]: d20Mn.append(float(i))
        for i in data2Mn[1]: d21Mn.append(float(i))
        ...
        p2Mn=ROOT.TGraph(len(data2Mn[1]),d20Mn, d21Mn)
