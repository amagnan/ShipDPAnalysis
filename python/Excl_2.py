...
if leptophilic:
    ...
    dataC = pd.read_csv(pathW+'Rate1.csv', header=None)
...
pl.plot(dataC[0], dataC[1], 'bl', label='SHiP (Combined)')

#pl.fill_between(data1[0], data1[1], y2=0, color='', edgecolor='blue', label='SHiP (QCD)')
#pl.fill_between(data3[0], data3[1], y2=0, color='', edgecolor='green', label="SHiP (Pbrem)") 
#pl.fill_between(data2[0], data2[1], y2=0, color='', edgecolor='red', label="SHiP (Mesons)")
