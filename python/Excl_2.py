...
pl.plot(data1[0], data1[1], 'b', linewidth=2.0, label='SHiP (QCD)')
pl.plot(data3[0], data3[1], 'g', linewidth=2.0,label='SHiP (Pbrem)')
pl.plot(data2[0], data2[1], 'r', linewidth=2.0,label='SHiP (Mesons)')
pl.plot(dataC[0], dataC[1], 'black', linewidth=1.8, label='SHiP (Combined)')
