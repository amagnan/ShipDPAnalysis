...
//=========  (Wed Apr  1 14:44:58 2020) by ROOT version 6.20/00
   TCanvas *c1 = new TCanvas("c1", "",0,45,1920,1035);
   c1->SetHighLightColor(2);
   c1->Range(1.083522,-18.04256,3.768197,-3.220259);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogx();
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Pbrem VDM",100,10,2290);
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Combined VDM",100,1.8,4509.8);
   ...
   multigraph->Add(graph,"");
   multigraph->Draw("AL");
   multigraph->GetXaxis()->SetLimits(-202.9, 4304.9);
   ...
   TLegend *leg = new TLegend(0.7,0.7,0.95,0.9,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   leg->SetLineWidth(1);
   ...
   leg = new TLegend(0.7,0.7,0.95,0.9,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetLineColor(1);
   leg->SetLineStyle(1);
   leg->SetLineWidth(1);
