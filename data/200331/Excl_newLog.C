...
//=========  (Wed Apr  1 15:10:02 2020) by ROOT version 6.20/00
   ...
   6.407078e-14,
   1.528136e-13};
   graph = new TGraph(94,Graph_fx3,Graph_fy3);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Pbrem VDM",100,1.8,2859.8);
   Graph_Graph3->SetMinimum(8.4701e-18);
   Graph_Graph3->SetMaximum(2.315169e-06);
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Combined VDM",100,1.8,3079.8);
   Graph_Graph4->SetMinimum(8.469983e-18);
   Graph_Graph4->SetMaximum(2.315265e-06);
