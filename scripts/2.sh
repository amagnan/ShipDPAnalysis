...
xrdcp "$1"_mass"$2"_eps"$3"_table_rec.dat     root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_true.dat   
xrdcp "$1"_mass"$2"_eps"$3"_table_e.dat       root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_e.dat     
xrdcp "$1"_mass"$2"_eps"$3"_table_mu.dat      root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_mu.dat    
xrdcp "$1"_mass"$2"_eps"$3"_table_pi.dat      root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_pi.dat    
xrdcp "$1"_mass"$2"_eps"$3"_table_ka.dat      root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_ka.dat    
xrdcp "$1"_mass"$2"_eps"$3"_table_oth.dat     root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_oth.dat   
xrdcp "$1"_mass"$2"_eps"$3"_table_mix.dat     root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_mix.dat   
xrdcp "$1"_mass"$2"_eps"$3"_table_tau.dat     root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_tau.dat   
xrdcp "$1"_mass"$2"_eps"$3"_table_single.dat  root://eospublic.cern.ch/"$DP"/ana/"$1"_mass"$2"_eps"$3"_table_single.dat
