...
dpMom = ''
zmin, zmax, ptmax = 0.1,0.9,4.0
cascade = False

try:
    opts, args = getopt.getopt(sys.argv[1:], "d:p:m:e:A:g:f:C:z:Z:t:", ["date=","production=","mass=","epsilon=","motherID=","geoFile=","final_dest=","cascade=","zmin=","zmax=","ptmax="])
...
print h['DP'].Integral(), h['DPpur'].Integral(), h['DPvesW'].Integral(), h['DPves'].Integral(), h['DPang'].Integral(), h['DPangW'].Integral(), h['DPangWe'].Integral()
